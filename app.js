...
import { 
  Plus, Search, Tag, ChevronRight, ChevronDown, Image as ImageIcon, Trash2, 
  Edit3, Layers, ChevronUp as ArrowUp, ChevronDown as ArrowDown, ChevronLeft,
  Save, Globe, Trello, List, X, Box, CheckCircle, Sliders, Filter,
  AlertTriangle, GripHorizontal, Calendar, Clock, AlertCircle, BarChart2,
  CalendarDays, Maximize2, ZoomIn, ZoomOut, MapPin, Image, Link, Expand,
  PanelLeftClose, PanelLeftOpen, FolderPlus, Settings, Download
} from 'lucide-react';

import { 
  parseSafeDate, formatDateToISO, getDaysDifference, db, auth, FIXED_APP_ID, 
  COLOR_OPTIONS, STATUS_COLORS, DEFAULT_SETTINGS, getTimeStatus, getIdeaPath, 
  getEffectiveDates, exportWorkspaceToExcel 
} from './utils.js';
